A = Function[T , Function[{arr,i,j},  
  ...
  rk3     = StringReplace[rk3  , "5*"->"5f*"]
  rk3     = StringReplace[rk3  , "2."->"2.f"]
  rk3     = StringReplace[rk3  , "1."->"1.f"]
  ...
  rk2     = StringReplace[rk2  , "5*"->"5f*"]
  rk2     = StringReplace[rk2  , "2."->"2.f"]
  rk2     = StringReplace[rk2  , "1."->"1.f"]
  ...
  rk1     = StringReplace[rk1  , "5*"->"5f*"]
  rk1     = StringReplace[rk1  , "2."->"2.f"]
  rk1     = StringReplace[rk1  , "1."->"1.f"]
